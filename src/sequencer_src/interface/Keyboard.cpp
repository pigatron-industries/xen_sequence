...
char keys[KEY_ROWS][KEY_COLS] = {
    ...
    {KEY_LOOP_MODE, KEY_LOOP_START, KEY_LOOP_END, KEY_PLACE_1},     
    {KEY_VIEW, KEY_SELECTION, KEY_FILE, KEY_HELP}, // UI Navigation
    {KEY_ADD_DEL, KEY_COPY, KEY_PASTE, KEY_PLACE_2},
    {KEY_PLACE_3, KEY_PLACE_4, KEY_PLACE_5, KEY_PLACE_6},
    {KEY_MOVE_MODE, KEY_MOVE, KEY_PLACE_7, KEY_PLACE_8}
};
